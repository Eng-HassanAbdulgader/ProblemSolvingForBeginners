...
int Row_sum(int arr[3][3], short rows, short cols)
{
    int sum = 0;
...
void Sum_Of_Rows(int arr[3][3], int array[3], short rows, short cols)
{
    for (int i = 0; i < rows; i++)
    {

        array[i] = Row_sum(arr, i, cols);
    }
}

void print_array(int arr[3], short size)
{
